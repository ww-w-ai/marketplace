...
# If settings.json statusLine points to an older super-token-saver version,
...
if (!current.includes('super-token-saver') || !current.endsWith('statusline-logger.sh')) process.exit(0);
